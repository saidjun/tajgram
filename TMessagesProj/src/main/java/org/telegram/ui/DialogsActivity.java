...
import static org.tajgram.ui.Components.AlertsCreator.createClearOrDeleteDialogsAlert;
...
import org.tajgram.messenger.FilesMigrationService;
...
import org.tajgram.messenger.utils.SearchTextWatcher;
...
import org.tajgram.ui.Cells.AccountSelectCell;
import org.tajgram.ui.Cells.ActiveGiftAuctionsHintCell;
import org.tajgram.ui.Cells.AnimatedStatusView;
import org.tajgram.ui.Cells.ArchiveHintInnerCell;
...
import org.tajgram.ui.Cells.UnconfirmedAuthHintCell;
...
import org.tajgram.ui.Components.DialogsActivityStatusLayout;
import org.tajgram.ui.Components.DialogsActivityTopBubblesFadeView;
import org.tajgram.ui.Components.DialogsActivityTopPanelLayout;
...
import org.tajgram.ui.Components.chat.ChatInputViewsContainer;
import org.tajgram.ui.Components.chat.ViewPositionWatcher;
import org.tajgram.ui.Components.inset.WindowInsetsStateHolder;
...
import org.tajgram.ui.Stories.StealthModeAlert;
...
import org.tajgram.ui.Components.DialogsItemAnimator;
import org.tajgram.ui.Components.FilterTabsView;
import org.tajgram.ui.Components.FiltersListBottomSheet;
...
import org.tajgram.ui.Components.FolderDrawable;
...
import org.tajgram.ui.Components.PacmanAnimation;
...
import org.tajgram.ui.Components.RecyclerAnimationScrollHelper;
import org.tajgram.ui.Components.RecyclerItemsEnterAnimator;
import org.tajgram.ui.Components.RecyclerListView;
import org.tajgram.ui.Components.SearchViewPager;
...
import org.tajgram.ui.Stories.UserListPoller;
    ...
    public View createView(final Context context) {
        ...
        if (onlySelect) {
            ...
            if (folderId != 0) {
                ...
                logoDrawable = context.getResources().getDrawable(R.drawable.tajgram_logo_2).mutate();
                logoDrawable.setBounds(0, dp(2), logoDrawable.getIntrinsicWidth(), dp(2) + logoDrawable.getIntrinsicHeight());
                logoDrawable.setColorFilter(getThemedColor(Theme.key_tajgram_color_dialogsLogo), PorterDuff.Mode.MULTIPLY);
        ...
        if (hasMainTabs) {
            ...
            actionBar.setTitleColor(getThemedColor(Theme.key_tajgram_color_dialogsLogo));
        }
...
//            }
        ...
        if (folderId == 0) {
            ...
            arrayList.add(new ThemeDescription(actionBar, ThemeDescription.FLAG_AB_TITLECOLOR, null, null, new Drawable[]{Theme.dialogs_holidayDrawable}, null, !hasMainTabs ? Theme.key_actionBarDefaultTitle : Theme.key_tajgram_color_dialogsLogo));
            ...
            arrayList.add(new ThemeDescription(actionBar, ThemeDescription.FLAG_AB_TITLECOLOR, null, null, new Drawable[]{Theme.dialogs_holidayDrawable}, null, !hasMainTabs ? Theme.key_actionBarDefaultArchivedTitle : Theme.key_tajgram_color_dialogsLogo));
        ...
        for (int a = 0; a < 3; a++) {
            ...
            arrayList.add(new ThemeDescription(list, 0, new Class[]{DialogCell.class}, null, new Drawable[]{Theme.dialogs_pinnedDrawable2Accent}, null, Theme.key_tajgram_color_text));
            ...
            arrayList.add(new ThemeDescription(list, 0, new Class[]{DialogCell.class}, Theme.dialogs_timePaintBoldAccent, null, null, Theme.key_tajgram_color_text));
        ...
        if (viewPages != null) {
            for (int a = 0; a < viewPages.length; a++) {
                ...
                arrayList.add(new ThemeDescription(viewPages[a].listView, 0, new Class[]{UserCell.class}, new String[]{"statusOnlineColor"}, null, null, cellDelegate, Theme.key_tajgram_color_text));
