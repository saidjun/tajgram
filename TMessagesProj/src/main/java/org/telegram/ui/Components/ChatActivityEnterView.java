...
import static org.tajgram.ui.LaunchActivity.getLastFragment;
...
import org.tajgram.messenger.BotForumHelper;
...
import org.tajgram.ui.Components.chat.SendButtonBlockedByTypingView;
import org.tajgram.ui.Components.chat.layouts.ChatActivitySideControlsButtonsLayout;
import org.tajgram.ui.Components.inset.WindowInsetsInAppController;
import org.tajgram.ui.ContentPreviewViewer;
import org.tajgram.ui.DialogsActivity;
import org.tajgram.ui.Gifts.GiftSheet;
import org.tajgram.ui.GroupStickersActivity;
import org.tajgram.ui.LaunchActivity;
import org.tajgram.ui.LinkManager;
import org.tajgram.ui.MessageSendPreview;
import org.tajgram.ui.MultiContactsSelectorBottomSheet;
...
import org.tajgram.ui.StickersActivity;
import org.tajgram.ui.Stories.HighlightMessageSheet;
import org.tajgram.ui.Stories.recorder.CaptionContainerView;
import org.tajgram.ui.Stories.recorder.HintView2;
import org.tajgram.ui.bots.BotCommandsMenuContainer;
import org.tajgram.ui.bots.BotCommandsMenuView;
import org.tajgram.ui.bots.BotKeyboardView;
import org.tajgram.ui.bots.BotWebViewAttachedSheet;
import org.tajgram.ui.bots.BotWebViewSheet;
import org.tajgram.ui.bots.ChatActivityBotWebViewButton;
        ...
        if (recordingAudioVideo) {
            ...
            try {
                if (wakeLock == null) {
                    ...
                    wakeLock = pm.newWakeLock(PowerManager.SCREEN_DIM_WAKE_LOCK | PowerManager.ON_AFTER_RELEASE, "tajgram:audio_record_lock");
                    wakeLock.acquire();
                }
            } catch (Exception e) {
                FileLog.e(e);
