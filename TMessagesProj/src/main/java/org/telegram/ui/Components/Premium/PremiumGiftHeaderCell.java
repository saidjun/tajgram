...
public class PremiumGiftHeaderCell extends LinearLayout {
    ...
    public void bind(TLRPC.User user) {
        ...
        titleView.setText(AndroidUtilities.replaceTags(LocaleController.getString(R.string.GiftTajgramPremiumTitle)));
        subtitleView.setText(AndroidUtilities.replaceTags(LocaleController.formatString(R.string.GiftTajgramPremiumDescription, user.first_name)));
    }
}
