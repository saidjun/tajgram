...
public class DatabaseMigrationHint extends FrameLayout {
    ...
    public DatabaseMigrationHint(Context context, int currentAccount) {
        ...
        title.setText(LocaleController.getString(R.string.OptimizingTajgram));
        ...
        description1.setText(LocaleController.getString(R.string.OptimizingTajgramDescription1));
        ...
        description2.setText(LocaleController.getString(R.string.OptimizingTajgramDescription2));
